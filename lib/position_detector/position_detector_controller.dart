...
/// A [PositionDetectorController] is a singleton object that can perform
/// actions and change configuration for all [VisibilityDetector] widgets.
class PositionDetectorController {
  static final _instance = PositionDetectorController();
  static PositionDetectorController get instance => _instance;
  ...
  void notifyNow() => PositionDetectorLayer.notifyNow();
  ...
  void forget(Key key) => PositionDetectorLayer.forget(key);
  ...
  /// not found.
  Rect? widgetBoundsFor(Key key) => PositionDetectorLayer.widgetBounds[key];
}
